...
import OfferFlightTable from "./OfferFlightTable";
import OfferHotelTable from "./OfferHotelTable";
...
const OfferHotel = () => {
  ...
  const getOffers = async () => {
    const getData = await OfferGetAPI("hotels");
  ...
  return (
    <main className="flight-offer">
      ...
      >
        <OfferHotelTable offers={offers} getOffers={getOffers} />
      </section>
    </main>
  );
};
